...
class SearchConfig(BaseConfig):
    def build_parser(self):
        ...
        parser.add_argument('--w_lr_min', type=float, default=0.0001, help='minimum lr for weights')
        ...
        parser.add_argument('--gpus', default='0,1', help='gpu device ids separated by comma. '
...
class TrainResnet50Config(BaseConfig):
    def build_parser(self):
        parser = get_parser("train resnet50 config")
        parser.add_argument('--name', required=True)
...
class TestConfig(BaseConfig):
    def build_parser(self):
        ...
        parser.add_argument('--gpus', default='0')
        parser.add_argument('--workers', type=int, default=4, help='# of workers')
        parser.add_argument('--weights', type=str, default="/mnt/disk_8t/lixu/pt_darts_v1/relatedwork/train/resnet50/checkpoint.pth.tar")
        return parser
    ...
    def __init__(self):
        ...
        self.data_path = './data/'
        self.path = os.path.join('test', self.name)
        self.gpus = parse_gpus(self.gpus)
