...
class WSIAugmentDataset(Dataset):
    ...
    def __init__(self, mode,transform):
        ...
        pos_dir = "/mnt/e/detectionData/patch/WSI2019_augment/Positive"
        neg_dir = "/mnt/e/detectionData/patch/WSI2019_augment/Negative"
        if mode=="train":
            pos_txt = "/mnt/e/detectionData/patch/WSI2019_augment/train_pos.txt"
            neg_txt = "/mnt/e/detectionData/patch/WSI2019_augment/train_neg.txt"
        elif mode=="eval":
            pos_txt = "/mnt/e/detectionData/patch/WSI2019_augment/eval_pos.txt"
            neg_txt = "/mnt/e/detectionData/patch/WSI2019_augment/eval_neg.txt"
        else:
